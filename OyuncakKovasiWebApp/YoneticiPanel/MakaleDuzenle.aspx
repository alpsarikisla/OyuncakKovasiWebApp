<%@ Page Title="" Language="C#" MasterPageFile="~/YoneticiPanel/MasterPage.Master" AutoEventWireup="true" CodeBehind="MakaleDuzenle.aspx.cs" Inherits="OyuncakKovasiWebApp.YoneticiPanel.MakaleDuzenle" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="formIcerik">
         <asp:Panel ID="pnl_basarili" runat="server" class="basariliPanel" Visible="false">
             <label>Makale düzenleme işlemi <b>başarıyla </b>gerçekleşti </label>
         </asp:Panel>
